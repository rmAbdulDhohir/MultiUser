                                ...
                                <form class="user" action="<?= url_to('register') ?>" method="post">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="password" name="password" class="form-control form-control-user <?php if (session('errors.password')) : ?>is-invalid<?php endif ?>" id="password" placeholder="<?= lang('Auth.password') ?>" autocomplete="off">
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <button type="submit" href="<?= base_url(); ?>/index.php" class="btn btn-success btn-user btn-block">
                                    <?=lang('Auth.register')?>
                                    </button>
                                    <hr>
